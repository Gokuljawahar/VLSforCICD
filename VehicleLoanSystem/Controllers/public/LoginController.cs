...
namespace VehicleLoanSystem.Controllers
{
    public class LoginController : Controller
    {
        ...
        public async Task<bool> ActivateAdminAccount()
        {
            ...
            return _context.Accounts.Any(e => e.IsAdmin);
        }
        ...
        public async Task<IActionResult> Login()
        {
            ...
            if (!_context.Accounts.Any(e => e.IsAdmin))
            {
        ...
        public async Task<IActionResult> Login([Bind("Id,User_Name,User_Password")] UserAccount userAccount)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                UserAccount user = _context.Accounts.FirstOrDefault(e => e.User_Name == username);
                if (user == null || !encoder.Compare(password, user.User_Password))
                {
